...
public class MinHeapTest {
    ...
    @Test
    public void testHeapifyDownPollMany() {
        assertEquals(5, minHeap.poll().getPrice());
        assertEquals(6, minHeap.poll().getPrice());
        assertEquals(8, minHeap.poll().getPrice());
        assertEquals(9, minHeap.poll().getPrice());
        assertEquals(15, minHeap.poll().getPrice());
        assertEquals(16, minHeap.poll().getPrice());
        assertEquals(17, minHeap.poll().getPrice());
        assertEquals(25, minHeap.poll().getPrice());
