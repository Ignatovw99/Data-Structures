...
public class BinarySearchTreeTest {
    ...
    @Test
    public void testContainsReturnedTrueIfKeyExists() {
        AbstractBinarySearchTree.Node<Integer> root = bst.getRoot();
    ...
    @Test
    public void testContainsReturnedFalseIfKeyDoesNotExist() {
        AbstractBinarySearchTree.Node<Integer> root = bst.getRoot();
    ...
    @Test
    public void testSearchCheckReturnedNullIfNotFound() {
        AbstractBinarySearchTree<Integer> searched = bst.search(110);
